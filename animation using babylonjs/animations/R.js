// R.js
export function animateR(hand, scene) {
    const fingers = {
        thumb: [],
        index: [],
        middle: [],
    ...
    // Apply the 'R' gesture (index and middle fingers crossed)
    fingers.index.forEach(bone => animateBone(bone, 0.1));  // Extend index finger
    fingers.middle.forEach(bone => animateBone(bone,0)); // Extend middle finger
