export function animateF(hand, scene) {
    const fingers = {
        thumb: [],
        index: [],
        middle: [],
    ...
    // Apply the 'F' gesture 
    fingers.index.forEach(bone => animateBone(bone, 1.0));   // Connect index finger with thumb
    ...
    fingers.thumb.forEach(bone => animateBone(bone, -1.0));    // Adjust thumb position
}
