// X.js
export function animateX(hand, scene) {
    const fingers = {
        thumb: [],
        index: [],
        middle: [],
    ...
    // Apply the 'X' gesture (index finger bent to form an X)
    fingers.index.forEach(bone => animateBone(bone, 2.5)); // Bend the Index finger to form X
